...
final case class ArrayHListN[H, T <: ArrayHList](underlying: Array[Any])
    extends AnyVal
    with (H A_:: T)
...
final case class UnrolledHList1[H1, T <: UnrolledHList](head1: H1, tail: T)
    extends (H1 U_:: T)
final case class UnrolledHList2[H1, H2, T <: UnrolledHList](head1: H1,
                                                            head2: H2,
                                                            tail: T)
    extends (H1 U_:: H2 U_:: T)
final case class UnrolledHList3[H1, H2, H3, T <: UnrolledHList](head1: H1,
                                                                head2: H2,
                                                                head3: H3,
                                                                tail: T)
    extends (H1 U_:: H2 U_:: H3 U_:: T)
final case class UnrolledHList4[H1, H2, H3, H4, T <: UnrolledHList](head1: H1,
                                                                    head2: H2,
                                                                    head3: H3,
                                                                    head4: H4,
                                                                    tail: T)
    extends (H1 U_:: H2 U_:: H3 U_:: H4 U_:: T)
