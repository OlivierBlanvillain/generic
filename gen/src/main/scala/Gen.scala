...
object Gen {
  ...
  object GenCreationBench extends Template {
    val path = "bench/src/test/scala/CreationBench.scala"
  ...
  object GenAccessLastBench extends Template {
    val path = "bench/src/test/scala/AccessLastBench.scala"
    def content(tv: TemplateVals) = {
      import tv._
  ...
  object GenAccessAllBench extends Template {
    val path = "bench/src/test/scala/AccessAllBench.scala"
    def content(tv: TemplateVals) = {
      import tv._
  ...
  object GenTailBench extends Template {
    val path = "bench/src/test/scala/TailBench.scala"
    def content(tv: TemplateVals) = {
      import tv._
