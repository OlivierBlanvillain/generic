...
class LastBench {
  ...
  @Benchmark def lastArrayHList11    : String = arrayHList11.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList12    : String = arrayHList12.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList13    : String = arrayHList13.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList14    : String = arrayHList14.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList15    : String = arrayHList15.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList16    : String = arrayHList16.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList17    : String = arrayHList17.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList18    : String = arrayHList18.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList19    : String = arrayHList19.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList20    : String = arrayHList20.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
  ...
  @Benchmark def lastArrayHList21    : String = arrayHList21.asInstanceOf[ArrayHListN[Any, ArrayHNil]].underlying.last.asInstanceOf[String]
